...
----These programs are done for Assignment-3 in Soft Computing Course-----


Problem : Face Recognition with PCA and LDA method and also comparision with only PCA method
...
WHAT I DID in Programs : It was given input as database of face images,
			...
			# Using the Algorithm : FACE RECOGNITION with PCA & LDA
...
RESULTS :  75%-85% of accuracy of face recognition will make. 
